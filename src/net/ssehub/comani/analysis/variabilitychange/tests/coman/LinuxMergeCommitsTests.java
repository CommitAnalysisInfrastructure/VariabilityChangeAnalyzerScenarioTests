 ...
 * <br>
 * These tests were used initially to check the ComAn tool-set for the correct handling of merge commits, which do not
...
public class LinuxMergeCommitsTests extends AbstractCommitsTests {
     ...
     */
    private static final File TEST_COMMITS_DIRECTORY = new File(AllTests.TESTDATA_DIRECTORY, "coman/linux");
