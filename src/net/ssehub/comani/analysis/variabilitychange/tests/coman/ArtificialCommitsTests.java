 ...
 * based on artificial commit files.<br>
 * <br>
...
public class ArtificialCommitsTests extends AbstractCommitsTests {
     ...
     */
    private static final File TEST_COMMITS_DIRECTORY = new File(AllTests.TESTDATA_DIRECTORY, "coman/artificial");
    
    /**
     * The names of the test commit files located in the {@link #TEST_COMMITS_DIRECTORY}.
     */
    private static final String[] TEST_COMMIT_FILE_NAMES = {"buildChangeCommit.txt", "modelChangeCommit.txt",
        "sourceChangeCommit.txt" };
    ...
    /**
     * Constructs a new {@link ArtificialCommitsTests} object for injecting test parameters.
     * 
    ...
    public ArtificialCommitsTests(String testcommitFileName, int expectedChangedCodeFiles,
    ...
    public static List<Object[]> getTestData() {
        return Arrays.asList(new Object[][] {
            {"sourceChangeCommit", 1, 12, 49, 0, 0, 0, 0, 0, 0},
            {"buildChangeCommit", 0, 0, 0, 1, 6, 6, 0, 0, 0},
            {"modelChangeCommit", 0, 0, 0, 0, 0, 0, 1, 45, 37}});
    }
    ...
    public static void tearDown() {
        tearDown("ArtificialCommitsTests");
    }
